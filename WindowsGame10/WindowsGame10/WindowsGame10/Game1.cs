...
namespace WindowsGame10
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        Level currentLevel = Levels.GetLevel(LevelDifficulties.Easy, 1);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(spriteFont, String.Format("Steps: {0}", stepsCount), new Vector2(1200, 150), textColor);
            ...
            if (CheckWin())
            {
                ...
                spriteBatch.DrawString(spriteFontWin, String.Format("You WIN!"), new Vector2(300, 100), Color.WhiteSmoke);
                spriteBatch.Draw(finalMole, Vector2.Zero, Color.White);
                spriteBatch.End();
            }
            else
            if (CheckLose())
